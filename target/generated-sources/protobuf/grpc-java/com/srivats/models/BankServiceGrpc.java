...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.srivats.models.BalanceCheckRequest,
      com.srivats.models.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.srivats.models.BalanceCheckRequest.class,
      responseType = com.srivats.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.srivats.models.BalanceCheckRequest,
      com.srivats.models.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.srivats.models.BalanceCheckRequest, com.srivats.models.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.srivats.models.BalanceCheckRequest, com.srivats.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.srivats.models.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.srivats.models.Balance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.srivats.models.WithDrawRequest,
      com.srivats.models.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.srivats.models.WithDrawRequest.class,
      responseType = com.srivats.models.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.srivats.models.WithDrawRequest,
      com.srivats.models.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.srivats.models.WithDrawRequest, com.srivats.models.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.srivats.models.WithDrawRequest, com.srivats.models.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.srivats.models.WithDrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.srivats.models.Money.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.srivats.models.DepositRequest,
      com.srivats.models.Balance> getCashDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cashDeposit",
      requestType = com.srivats.models.DepositRequest.class,
      responseType = com.srivats.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.srivats.models.DepositRequest,
      com.srivats.models.Balance> getCashDepositMethod() {
    io.grpc.MethodDescriptor<com.srivats.models.DepositRequest, com.srivats.models.Balance> getCashDepositMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getCashDepositMethod = BankServiceGrpc.getCashDepositMethod) == null) {
          BankServiceGrpc.getCashDepositMethod = getCashDepositMethod =
              io.grpc.MethodDescriptor.<com.srivats.models.DepositRequest, com.srivats.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "cashDeposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.srivats.models.DepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.srivats.models.Balance.getDefaultInstance()))
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBalance(com.srivats.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.srivats.models.Balance> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetBalanceMethod(), responseObserver);
    }

    /**
     */
    public void withdraw(com.srivats.models.WithDrawRequest request,
        io.grpc.stub.StreamObserver<com.srivats.models.Money> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getWithdrawMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<com.srivats.models.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.srivats.models.Balance> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.srivats.models.BalanceCheckRequest,
                com.srivats.models.Balance>(
                  this, METHODID_GET_BALANCE)))
          .addMethod(
            getWithdrawMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.srivats.models.WithDrawRequest,
                com.srivats.models.Money>(
                  this, METHODID_WITHDRAW)))
          .addMethod(
            getCashDepositMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                com.srivats.models.DepositRequest,
                com.srivats.models.Balance>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public com.srivats.models.Balance getBalance(com.srivats.models.BalanceCheckRequest request) {
    ...
    /**
     */
    public java.util.Iterator<com.srivats.models.Money> withdraw(
        com.srivats.models.WithDrawRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.srivats.models.Balance> getBalance(
        com.srivats.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.srivats.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.srivats.models.Balance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.srivats.models.WithDrawRequest) request,
              (io.grpc.stub.StreamObserver<com.srivats.models.Money>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.srivats.models.BankServiceOuterClass.getDescriptor();
    }
